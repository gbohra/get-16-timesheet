...
import com.oauth.springmvc.model.AuthTokenInfo;
import com.oauth.springmvc.model.User;
 
public class SpringRestClient {
 
    public static final String REST_SERVICE_URI = "http://localhost:8080/SpringOAuth2";
    
    public static final String AUTH_SERVER_URI = "http://localhost:8080/SpringOAuth2/oauth/token";
    
    public static final String QPM_PASSWORD_GRANT = "?grant_type=password&username=bill&password=abc123";
    
    public static final String QPM_ACCESS_TOKEN = "?access_token=";

    // http://localhost:8080/SpringOAuth2/oauth/token?grant_type=password&username=bill&password=abc123
    /*
